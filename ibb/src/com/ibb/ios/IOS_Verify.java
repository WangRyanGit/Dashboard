...
public class IOS_Verify {
     ...
     *
     */
    public static String buyAppVerify(String receipt,String password,String verifyState)
    {
        String url=url_verify;
        if(verifyState!=null && verifyState.equals("Sandbox")){
            url=url_sandbox;
        }
        //String receiptData=getBASE64(receipt);
        String receiptData=receipt;
        try{
            ...
            String str= String.format(Locale.CHINA,"{\"receipt-data\":\"" + receiptData+"\",\"password\": \"" + password + "\"}");
