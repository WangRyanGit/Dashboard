                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf">FOLLOW用户</div>
                        ...
                        <div class="widget-body  am-fr">
                            ...
                            <form id="form" method="get" action="<%=basePath%>/followcontrol/showAllFollowData">
                                <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                ...
                                <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                        <input type="text" class="am-form-field " name="user_id" placeholder="user_id">
                                    </div>
                                </div>
                            ...
                            <div class="am-u-sm-12">
                                <form id="form1" method="post" action="<%=basePath%>/followcontrol/showAllFollowData">
                                            ...
                                            <c:forEach items="${requestScope.pagelist.lists}" var="pg">
                                                ...
                                                <tr class="gradeX">
                                                    ...
                                                    <td>
                                                        ...
                                                        <c:if test="${pg.status == -1}"><font color="#a9a9a9"> 禁用 </font></c:if>
                                                    </td>
                                                    <td>
                                                        <div class="tpl-table-black-operation">
                                                            <a href="<%=basePath%>/followcontrol/toEditFollowData?id=${pg.id}">
                                ...
                                <div class="am-fr">
                                    <ul class="am-pagination tpl-pagination">
                                        ...
                                        <c:if test="${requestScope.pagelist.currPage != 1}">
                                            <li><a href="${pageContext.request.contextPath }/followcontrol/showAllFollowData?currentPage=1&pkg=${requestScope.pagelist.pkg}&user_id=${requestScope.pagelist.user_id}">«</a></li>
                                            <li><a href="${pageContext.request.contextPath }/followcontrol/showAllFollowData?currentPage=${requestScope.pagelist.currPage-1}&pkg=${requestScope.pagelist.pkg}&user_id=${requestScope.pagelist.user_id}">‹</a></li>
                                        </c:if>
                                        <c:if test="${requestScope.pagelist.currPage != requestScope.pagelist.totalPage}">
                                            <li><a href="${pageContext.request.contextPath }/followcontrol/showAllFollowData?currentPage=${requestScope.pagelist.currPage+1}&pkg=${requestScope.pagelist.pkg}&user_id=${requestScope.pagelist.user_id}">›</a></li>
                                            <li><a href="${pageContext.request.contextPath }/followcontrol/showAllFollowData?currentPage=${requestScope.pagelist.totalPage}&pkg=${requestScope.pagelist.pkg}&user_id=${requestScope.pagelist.user_id}">»</a></li>
                                        </c:if>
