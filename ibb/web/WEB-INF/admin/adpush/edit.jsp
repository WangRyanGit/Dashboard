                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">编辑推送信息 AdPush</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-border-form tpl-form-border-br" action="<%=basePath%>/push/editAdPush" method="post">

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">编号 <span class="tpl-form-line-small-title">Id</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="id" value="${adpush.id}" readonly><!-- 传id值 -->
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="pkg" value="${adpush.pkg}">
                                ...
                                <%--<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" style="display: none;" name="country" >
                                            <option value="${adpush.country}" selected="selected">${adpush.country}</option>
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">推送信息 <span class="tpl-form-line-small-title">Message</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="message" value="${adpush.message}">
                                        <small>修改推送信息</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" style="display: none;" name="status">
                                            <option value="${adpush.status}" selected="selected">
                                                <c:if test="${adpush.status == 0}"> 正常 </c:if>
                                                <c:if test="${adpush.status == -1}"> 下线 </c:if>
                                            </option>
