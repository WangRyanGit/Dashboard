...
<head lang="en">
    ...
    <title>推送数据界面</title>
    <meta name="description" content="这是一个 push 页面">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf">推送列表 AdPush</div>
                        ...
                        <div class="widget-body  am-fr">
                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button type="button" class="am-btn am-btn-default am-btn-success" onClick="location.href='<%=basePath%>/push/toAddAdPush'"><span class="am-icon-plus"></span>新增</button>
                            ...
                            <form id="form" method="get" action="<%=basePath%>/push/showAllAdPush">
                            ...
                            <div class="am-u-sm-12">
                                <form id="form1" method="post" action="<%=basePath%>/push/showAllAdPush">
                                ...
                                <div class="am-fr">
                                    <ul class="am-pagination tpl-pagination">
                                        ...
                                        <c:if test="${requestScope.pagelist.currPage != 1}">
                                            <li><a href="${pageContext.request.contextPath }/push/showAllAdPush?currentPage=1&pkg=${requestScope.pagelist.pkg}">«</a></li>
                                            <li><a href="${pageContext.request.contextPath }/push/showAllAdPush?currentPage=${requestScope.pagelist.currPage-1}&pkg=${requestScope.pagelist.pkg}">‹</a></li>
                                        </c:if>
                                        <c:if test="${requestScope.pagelist.currPage != requestScope.pagelist.totalPage}">
                                            <li><a href="${pageContext.request.contextPath }/push/showAllAdPush?currentPage=${requestScope.pagelist.currPage+1}&pkg=${requestScope.pagelist.pkg}">›</a></li>
                                            <li><a href="${pageContext.request.contextPath }/push/showAllAdPush?currentPage=${requestScope.pagelist.totalPage}&pkg=${requestScope.pagelist.pkg}">»</a></li>
                                        </c:if>
