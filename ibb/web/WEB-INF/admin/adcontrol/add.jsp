                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">添加控制 AdControl</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-border-form tpl-form-border-br" action="<%=basePath%>/control/addAdControl" method="post">

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">包名 <span class="tpl-form-line-small-title">BundleId</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="pkg" placeholder="pkg">
                                        <small>请填加BundleId。</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="position" placeholder="position">
