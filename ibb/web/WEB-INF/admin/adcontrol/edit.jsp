                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">编辑控制 AdControl</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-border-form tpl-form-border-br" action="<%=basePath%>/control/editAdControl" method="post">

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">编号 <span class="tpl-form-line-small-title">Id</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="id" value="${adcontrol.id}" readonly><!-- 传id值 -->
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="pkg" value="${adcontrol.pkg}">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" style="display: none;" name="country" >
                                            <option value="${adcontrol.country}" selected="selected">${adcontrol.country}</option>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="position" value="${adcontrol.position}">
                                        <small>原生100开始(150原生代banner,151Admob大Key),插屏200起,banner300起</small>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">预留字段 <span class="tpl-form-line-small-title">Reserved</span></label>
                                    <div class="am-u-sm-3">
                                        <input type="text" class="tpl-form-input" name="showOn" value="1" readonly><span>showOn</span>
                                    </div>
                                    <div class="am-u-sm-3">
                                        <input type="text" class="tpl-form-input" name="initOn" value="1" readonly><span>initOn</span>
                                    </div>
                                    <div class="am-u-sm-3">
                                        <input type="text" class="tpl-form-input" name="requestInterval" value="600" readonly><span>requestInterval</span>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" style="display: none;" name="status">
                                            <option value="${adcontrol.status}" selected="selected">
                                                <c:if test="${adcontrol.status == 1}"> 正常 </c:if>
                                                <c:if test="${adcontrol.status == 0}"> 下线 </c:if>
                                            </option>
