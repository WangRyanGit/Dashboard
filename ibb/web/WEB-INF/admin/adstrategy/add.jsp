                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">添加策略 AdStrategy</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-border-form tpl-form-border-br" action="<%=basePath%>/strategy/addAdStrategy" method="post">
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">广告Key <span class="tpl-form-line-small-title">Offer Key</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="adId" placeholder="adId">
                                        <small>请填加广告key。</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="priority" placeholder="priority">
