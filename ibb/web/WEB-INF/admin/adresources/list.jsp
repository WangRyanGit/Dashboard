...
<head lang="en">
    ...
    <title>数据源界面</title>
    <meta name="description" content="这是一个 rosurces 页面">
    <meta name="keywords" content="rources">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf">数据源列表 AdResources</div>
                        ...
                        <div class="widget-body  am-fr">
                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button type="button" class="am-btn am-btn-default am-btn-success" onClick="location.href='<%=basePath%>/resources/toAddAdResources'"><span class="am-icon-plus"></span>新增</button>
                            ...
                            <form id="form" method="get" action="<%=basePath%>/resources/showAllAdResources">
                            ...
                            <div class="am-u-sm-12">
                                <form id="form1" method="post" action="<%=basePath%>/resources/showAllAdResources">
                                    ...
                                    <c:if test="${!empty requestScope.pagelist}">
                                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
                                            ...
                                            <c:forEach items="${requestScope.pagelist.lists}" var="pg">
                                                <tbody>
                                                <c:if test="${fn:containsIgnoreCase(pg.pkg,'music')}">
                                                    <tr class="gradeX">
                                                        ...
                                                        <td>${pg.typekey}</td>
                                                        <td>
                                                            <c:if test="${pg.type == 1}">使用Sound</font></c:if>
                                                            <c:if test="${pg.type == 2}">使用Jam </font></c:if>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="tpl-table-black-operation">
                                                                <a href="<%=basePath%>/resources/toEditAdResources?id=${pg.id}">
                                                                    <i class="am-icon-pencil"></i> 编辑
                                                                </a>
                                                                <a href="<%=basePath%>/resources/deleteAdResources?id=${pg.id}" class="tpl-table-black-operation-del" onclick="alert('确认删除')">
                                                ...
                                                <c:if test="${!fn:containsIgnoreCase(pg.pkg,'music')}">
                                                    <tr class="gradeX">
                                                        ...
                                                        <td>${pg.typekey}</td>
                                                        <td>
                                                            <c:if test="${pg.type == 1}">使用</font></c:if>
                                                            <c:if test="${pg.type == 2}">未使用 </font></c:if>
                                                        </td>
                                                        <td>
                                                            <c:if test="${pg.status == 0}"><font color="green"> 正常</font></c:if>
                                                            <c:if test="${pg.status == -1}"><font color="#a9a9a9"> 下线 </font></c:if>
                                ...
                                <div class="am-fr">
                                    <ul class="am-pagination tpl-pagination">
                                        ...
                                        <c:if test="${requestScope.pagelist.currPage != 1}">
                                            <li><a href="${pageContext.request.contextPath }/resources/showAllAdResources?currentPage=1&pkg=${requestScope.pagelist.pkg}">«</a></li>
                                            <li><a href="${pageContext.request.contextPath }/resources/showAllAdResources?currentPage=${requestScope.pagelist.currPage-1}&pkg=${requestScope.pagelist.pkg}">‹</a></li>
                                        </c:if>
                                        <c:if test="${requestScope.pagelist.currPage != requestScope.pagelist.totalPage}">
                                            <li><a href="${pageContext.request.contextPath }/resources/showAllAdResources?currentPage=${requestScope.pagelist.currPage+1}&pkg=${requestScope.pagelist.pkg}">›</a></li>
                                            <li><a href="${pageContext.request.contextPath }/resources/showAllAdResources?currentPage=${requestScope.pagelist.totalPage}&pkg=${requestScope.pagelist.pkg}">»</a></li>
                                        </c:if>
