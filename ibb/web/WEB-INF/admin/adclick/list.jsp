...
<head lang="en">
    ...
    <title>点击频率界面</title>
    <meta name="description" content="这是一个 adclick 页面">
    <meta name="keywords" content="adclick">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf">频率列表 AdClick</div>
                        ...
                        <div class="widget-body  am-fr">
                                ...
                                <div class="am-form-group">
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <button type="button" class="am-btn am-btn-default am-btn-success" onClick="location.href='<%=basePath%>/click/toAddAdClick'"><span class="am-icon-plus"></span>新增</button>
                            ...
                            <form id="form" method="get" action="<%=basePath%>/click/showAllAdClick">
                            ...
                            <div class="am-u-sm-12">
                                <form id="form1" method="post" action="<%=basePath%>/click/showAllAdClick">
                                                ...
                                                <tr class="gradeX">
                                                    ...
                                                    <td>
                                                        <div class="tpl-table-black-operation">
                                                            <a href="<%=basePath%>/click/toEditAdClick?id=${pg.id}">
                                                                <i class="am-icon-pencil"></i> 编辑
                                                            </a>
                                                            <a href="javascript:void(0)" class="tpl-table-black-operation-del" onClick="deleteId(${pg.id})">
                                                                <i class="am-icon-trash"></i> 删除
                                                            </a>
                                                            <%--<a href="<%=basePath%>/click/deleteAdClick?id=${pg.id}" class="tpl-table-black-operation-del" onclick="alert('确认删除')">
                                                                <i class="am-icon-trash"></i> 删除
                                                            </a>--%>
                                                        </div>
                                                    </td>
                                ...
                                <div class="am-fr">
                                    <ul class="am-pagination tpl-pagination">
                                        ...
                                        <c:if test="${requestScope.pagelist.currPage != 1}">
                                            <li><a href="${pageContext.request.contextPath }/click/showAllAdClick?currentPage=1&pkg=${requestScope.pagelist.pkg}">«</a></li>
                                            <li><a href="${pageContext.request.contextPath }/click/showAllAdClick?currentPage=${requestScope.pagelist.currPage-1}&pkg=${requestScope.pagelist.pkg}">‹</a></li>
                                        </c:if>
                                        <c:if test="${requestScope.pagelist.currPage != requestScope.pagelist.totalPage}">
                                            <li><a href="${pageContext.request.contextPath }/click/showAllAdClick?currentPage=${requestScope.pagelist.currPage+1}&pkg=${requestScope.pagelist.pkg}">›</a></li>
                                            <li><a href="${pageContext.request.contextPath }/click/showAllAdClick?currentPage=${requestScope.pagelist.totalPage}&pkg=${requestScope.pagelist.pkg}">»</a></li>
                                        </c:if>
...
<script type="text/javascript">
    ...
    function batchDelete(){
        if(confirm("真的要删除这批策略吗?")){
            $("#form1").attr("action","<%=basePath%>/click/batchDelete");
            $("#form1").submit();
        }
    }
    /*   单个删除   */
    function deleteId(id){
        if(confirm("真的要删除吗?")){
            $("#form1").attr("action","<%=basePath%>/click/deleteAdClick?id="+id);
            $("#form1").submit();
        }
    }
</script>
