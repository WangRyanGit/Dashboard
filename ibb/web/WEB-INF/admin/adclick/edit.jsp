                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">编辑频率 AdClick</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-border-form tpl-form-border-br" action="<%=basePath%>/click/editAdClick" method="post">

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">编号 <span class="tpl-form-line-small-title">Id</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="id" value="${adclick.id}" readonly><!-- 传id值 -->
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="pkg" value="${adclick.pkg}">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" style="display: none;" name="country" >
                                            <option value="${adclick.country}" selected="selected">${adclick.country}</option>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="position" value="${adclick.position}">
                                        <small>原生100开始(150原生代banner,151Admob大Key),插屏200起,banner300起</small>
                                    </div>
                                </div>

                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">最小点击次数 <span class="tpl-form-line-small-title">MinClick</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="minClick" value="${adclick.minClick}">
                                        <small>目前主要应用于插屏广告</small>
                                    </div>
                                </div>
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">最大点击次数 <span class="tpl-form-line-small-title">MaxClick</span></label>
                                    <div class="am-u-sm-9">
                                        <input type="text" class="tpl-form-input" name="maxClick" value="${adclick.maxClick}">
                                        <small>目前主要应用于插屏广告</small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <select data-am-selected="{searchBox: 1}" style="display: none;" name="status">
                                            <option value="${adclick.status}" selected="selected">
                                                <c:if test="${adclick.status == 0}"> 正常 </c:if>
                                                <c:if test="${adclick.status == -1}"> 下线 </c:if>
                                            </option>
